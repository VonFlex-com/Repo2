package beans_modele_OLD;

import java.io.InputStream;
import java.sql.Timestamp;

public class BDItemOLD {
	...
	public BDItemOLD(String serie, String titre, InputStream inputStream, String resume, String langue, Timestamp date_crea,
...
//constructeur List items
	public BDItemOLD(int bd_id, String serie, String titre, String vignette, String resume, String langue, Timestamp date_crea,
			Timestamp date_upload, int note_id, int auteur_id, int genre_id) {
		super();
		this.bd_id = bd_id;
		this.serie = serie;
