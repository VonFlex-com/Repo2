...
<div class="page">
	...
	<div class="corpsMinHeight" align="center">
		...
		<br>
		<span class="alerte" id="result"></span>
		<form action="<%=request.getContextPath()%>/register" method="post">
			<table style="with: 100%">
				<tr>
					<td>Email</td>
					<td><input id="userName" type="text" name="email" required minlength="3" /></td>
				</tr>
				<tr>
					<td>Pseudo</td>
			...
			<br> <input class="centre titrePage logo ahref" type="submit" value="Submit" />
		</form>
		...
		<c:if test="${ !empty regForm.messageOk }">
			...
			<br>
			<a href="./login" type="button" class="centre titrePage neonRouge logo">Connexion</a>
		</c:if>
